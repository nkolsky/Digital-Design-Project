...
logic [10:0] counter = 0; //11 bits to count up to 1736 (but can actually reach 2047, but we will reset at 1736 or 109 depending on mode)
logic [10:0] divisor;
